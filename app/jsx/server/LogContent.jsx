...
export default function LogContent(props) {
  ...
  function getLogs() {
    return context.api
      .proxyGet(`/container/${id}/logs/`, { name, tail })
      .then((result) => {
      ...
      .fail((xhr, textStatus, errorThrown) =>
        context.setErrorMessage(
          `Error getting log: ${xhr.responseText} - ${errorThrown}`
        )
      );
  }
    ...
    <div>
      ...
      <label>
        ...
        <input
          ...
          onClick={(evt) => setAutoUpdate(!autoUpdate)}
          type="checkbox"
        />
      </label>
